...
void main() {
  group('BoundingBox', () {
    ...
    test('creates from extents', () {
      ...
      final bb = BoundingBox.forExtents(center, 10, 20);
      expect(bb.left, -10);
      expect(bb.bottom, -20);
      expect(bb.right, 10);
      expect(bb.top, 20);
    ...
    test('creates for circle', () {
      ...
      final bb = BoundingBox.forCircle(position, 10);
      expect(bb.left, closeTo(-10, 0.001));
      expect(bb.bottom, closeTo(-10, 0.001));
      expect(bb.right, closeTo(10, 0.001));
      expect(bb.top, closeTo(10, 0.001));
    });
