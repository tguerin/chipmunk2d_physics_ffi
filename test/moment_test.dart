...
void main() {
  group('Moment', () {
    ...
    test('areaForCircle', () {
      ...
      expect(area, closeTo(314.159, 1)); // π * r^2
    });
    ...
    test('areaForPoly', () {
      ...
      expect(area, closeTo(100.0, 1)); // 10 * 10 square
    });
    ...
    test('centroidForPoly', () {
      ...
      expect(centroid.x, closeTo(5, 1));
      expect(centroid.y, closeTo(5, 1));
    });
    ...
    test('momentForBox2', () {
      const mass = 1.0;
      const box = BoundingBox(left: -5, bottom: -10, right: 5, top: 10);
