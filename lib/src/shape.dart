...
/// - Check [disposed] to see if the shape has been disposed
/// - Using a disposed shape will result in undefined behavior (native crash)
///
...
abstract class Shape {
  ...
  /// Whether this shape has been disposed.
