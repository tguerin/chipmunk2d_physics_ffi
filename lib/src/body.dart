...
/// - Check [disposed] to see if the body has been disposed
/// - Using a disposed body will result in undefined behavior (native crash)
///
...
class Body {
  ...
  /// Whether this body has been disposed.
