...
/// - Check [disposed] to see if the constraint has been disposed
/// - Using a disposed constraint will result in undefined behavior (native crash)
abstract class Constraint {
  ...
  /// Whether this constraint has been disposed.
